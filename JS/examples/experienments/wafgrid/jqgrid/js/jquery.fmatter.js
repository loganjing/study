...
"use strict";
	...
	$.fn.fmatter.showlink = function(cellval, opts) {
        ...
        if(op.onclick){
            ...
            click = "jQuery.fn.fmatter.rowoperations('" + opts.rowId + "','" + opts.gid + "','" + op.addParam + "'," + opts.pos + "," + op.onclick + ");";
        }
...
//			return $.fn.fmatter.defaultFormat(cellval, opts);
            //comment above code and add this line.add by jlg
	...
	$.unformat = function (cellval,opr,pos,cnt) {
		...
		if(typeof unformatFunc !== 'undefined' && $.isFunction(unformatFunc) ) {
			...
			switch(formatType) {
                ...
                case 'wafcheckbox':
                    return $.unformat.wafcheckbox(cellval,options);
                case 'f7':
                    return $.unformat.f7(cellval,options,pos,cnt);
                case 'numberfield':
                    return $.unformat.numberfield(cellval,options,pos,cnt);
                case 'operations':
                    return "";
                case 'datepicker':
                    return $.unformat.datepicker(cellval,options,pos,cnt);
                case 'waftext':
                case 'autoComplete':
                case 'wafTextArea':
                    return $.unformat.waftext(cellval,options,pos,cnt);
                case 'wafMultiLangArea':
                    return $.unformat.wafMultiLangArea(cellval,options,pos,cnt);
                case 'wafMultiLangBox':
                    return $.unformat.wafMultiLangBox(cellval,options,pos,cnt);
                case 'wafenum':
                    return $.unformat.wafenum(cellval,options,pos,cnt);
                case 'wafboolean':
                    return $.unformat.wafboolean(cellval,options,pos,cnt);
				default:
					ret= $(cellval).text();
			}
		}
